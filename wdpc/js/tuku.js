$(function(){
	...
	$('.tuku_header').on('click', '.tuku_header_item', function(event) {
		$('.tuku_header_item').removeClass('act')
		$(this).addClass('act')
	...
	window.setInterval(function(){
		...
		var $tleItems = $('.tuku_header').find('.tuku_header_item')
		var nextIndex = 0
		for (var i = 0; i < $tleItems.length; i++) {
			if($tleItems.eq(i).hasClass('act')){
				nextIndex = i;
				break;
			}
		};
